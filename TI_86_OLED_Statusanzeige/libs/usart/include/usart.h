...
#else
#define USART0_CONFIG_B                                                        \
  (1 << TXEN0_BIT) | (1 << RXEN0_BIT) | (1 << RXCIE0_BIT) | (1 << UCSZ02_BIT)
#endif
#endif
#else
#if defined(NO_RX0_INTERRUPT)
...
#ifdef USART0_RS485_MODE
#define USART0_CONFIG_B                                                        \
  (1 << TXEN0_BIT) | (1 << TXCIE0_BIT) | (1 << RXEN0_BIT) | (1 << RXCIE0_BIT)
#else
...
#else
#define USART1_CONFIG_B                                                        \
  (1 << TXEN1_BIT) | (1 << RXEN1_BIT) | (1 << RXCIE1_BIT) | (1 << UCSZ12_BIT)
#endif
#endif
#else
#if defined(NO_RX1_INTERRUPT)
...
#ifdef USART1_RS485_MODE
#define USART1_CONFIG_B                                                        \
  (1 << TXEN1_BIT) | (1 << TXCIE1_BIT) | (1 << RXEN1_BIT) | (1 << RXCIE1_BIT)
#else
...
#else
#define USART2_CONFIG_B                                                        \
  (1 << TXEN2_BIT) | (1 << RXEN2_BIT) | (1 << RXCIE2_BIT) | (1 << UCSZ22_BIT)
#endif
#endif
#else
#if defined(NO_RX2_INTERRUPT)
...
#ifdef USART2_RS485_MODE
#define USART2_CONFIG_B                                                        \
  (1 << TXEN2_BIT) | (1 << TXCIE2_BIT) | (1 << RXEN2_BIT) | (1 << RXCIE2_BIT)
#else
...
#else
#define USART3_CONFIG_B                                                        \
  (1 << TXEN3_BIT) | (1 << RXEN3_BIT) | (1 << RXCIE3_BIT) | (1 << UCSZ32_BIT)
#endif
#endif
#else
#if defined(NO_RX3_INTERRUPT)
...
#ifdef USART3_RS485_MODE
#define USART3_CONFIG_B                                                        \
  (1 << TXEN3_BIT) | (1 << TXCIE3_BIT) | (1 << RXEN3_BIT) | (1 << RXCIE3_BIT)
#else
...
#define uart0_puts(str)                                                        \
  uart0_putstr((const char *)(str)) // macro to avoid const char* conversion
                                    // restrictions
#else
// for deprecated usage only
...
#else
void uart0_puts_p(const char __flash *string); // send string from flash memory
#endif
...
#define uart1_puts(str)                                                        \
  uart1_putstr((const char *)(str)) // macro to avoid const char* conversion
                                    // restrictions
#else
...
#else
void uart1_puts_p(const char __flash *string); // send string from flash memory
#endif
...
#define uart2_puts(str)                                                        \
  uart2_putstr((const char *)(str)) // macro to avoid const char* conversion
                                    // restrictions
#else
...
#else
void uart2_puts_p(const char __flash *string); // send string from flash memory
#endif
...
#define uart3_puts(str)                                                        \
  uart3_putstr((const char *)(str)) // macro to avoid const char* conversion
                                    // restrictions
#else
...
#else
void uart3_puts_p(const char __flash *string); // send string from flash memory
#endif
...
// wrapper of stdio.h FDEV_SETUP_STREAM to allow setting udata; udata is used to
// store info about port ID
